...
public class CookieFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            for (Cookie c : cs) {
                if (c.getName().equalsIgnoreCase("user") && !c.getValue().equals("")) {
                    code = c.getValue();
                    for (Account account : list) {
                        if (code.equals(account.toEncode())) {
                    ...
                    if (check) {
                        ...
                        c.setMaxAge(0);
                        res.addCookie(c);
                        session.setAttribute("error", "You is change password please login again!");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("CookieFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("CookieFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("CookieFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("CookieFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("CookieFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
