<%-- 
    Document   : body_sale
    Created on : Dec 11, 2019, 9:32:50 PM
    ...
    <body>
        ...
        <div class="container-fluid">
            <div>
                <h3>
                    <span>
                        <i class="glyphicon glyphicon-book"></i> ${param.isSearch} Sale
                    </span>
                    <hr>
                </h3>
            </div>
        ...
        <div class="container-fluid" style="text-align: center;">
            <ul class="pagination">
                <c:forEach var="i" begin="1" end="${p.pagesSale}" step="1">
                ...
                <c:if test="${param.page lt p.pagesSale}">
                    <c:url value="home" var="next">
                        <c:forEach var="para" items="${parameters}">
        ...
        <div class="container-fluid">
            <div class="col-md-12 col-lg-12 col-xs-12">
                <div class="row">
                    <c:if test="${not empty p.sales}">
                        <c:forEach var="b" items="${p.sales}">   
